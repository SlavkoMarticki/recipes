...
export default function AddRecipe(props){
    ...
    const handleInput = (event) => {
        ...
        if(event.target.value === "addButton"){
            setNewRecipe({title:titleRef.current.value, instructions: titleRef.current.value, img: imageRef.current.value});
            alert("you add new recipe");
        }
    }
    ...
    return (<div>
        ...
        <div className="addRecipeBlock">
            ...
            <div className="addRecipeBlock__inputs">
                ...
                <textarea id="instructions" name="instructions"  ref={instructionsRef}/> 
                <button value="addButton" onClick={handleInput}>Add</button>
